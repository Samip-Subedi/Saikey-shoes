...
// export const CLEAR_VERIFICATION_STATES = "CLEAR_VERIFICATION_STATES";

// Your existing constants (keep all of these)
export const LOGIN_REQUEST = "LOGIN_REQUEST";
export const LOGIN_FAIL = "LOGIN_FAIL";
export const LOGIN_SUCCESS = "LOGIN_SUCCESS";
...
// NEW: Email Verification Constants (ADD THESE)
export const VERIFY_EMAIL_REQUEST = "VERIFY_EMAIL_REQUEST";
export const VERIFY_EMAIL_SUCCESS = "VERIFY_EMAIL_SUCCESS";
export const VERIFY_EMAIL_FAIL = "VERIFY_EMAIL_FAIL";

// NEW: Resend Verification Email Constants (ADD THESE)
export const RESEND_VERIFICATION_REQUEST = "RESEND_VERIFICATION_REQUEST";
export const RESEND_VERIFICATION_SUCCESS = "RESEND_VERIFICATION_SUCCESS";
export const RESEND_VERIFICATION_FAIL = "RESEND_VERIFICATION_FAIL";

// NEW: Clear Email Verification States (ADD THIS)
export const CLEAR_VERIFICATION_STATES = "CLEAR_VERIFICATION_STATES";
